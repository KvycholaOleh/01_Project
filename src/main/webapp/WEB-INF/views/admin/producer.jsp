		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/producer">Producer</a><span class="sr-only">(current)</span></li>
...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		...
		<c:forEach items="${producers}" var="producers">
			<div class="row">
				<div class="col-md-4 col-xs-4">${producers.name}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-warning"
						href="/admin/producer/update/${producers.id}">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/producer/delete/${producers.id}">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
